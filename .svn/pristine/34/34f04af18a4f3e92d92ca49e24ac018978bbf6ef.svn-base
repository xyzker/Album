...
<tr>
	...
	<input id="login" type="button" style="cursor:pointer" onclick="proLogin();" value="登陆" />
	<input id="resetLogin" type="button" style="cursor:pointer" onclick="reset();" value="重设" />
	</div>
...
<div id="hasLogin" align="center">
	欢迎<span id="username" style="color:blue"><s:property value="#session.user.name"/></span>，您正在浏览用户<span style="color:blue"><s:property value="user.name"/></span>的相片，您也可以<a href="" style="color:red">返回</a>自己的主页
	
</div>
<div align="right">
<a href="javascript:void(0)" onclick="logout();" style="align:right">退出登陆</a>
</div>
</s:else>
</td>
</tr>
<tr>
	...
	<div id="list" align="center">
		<s:iterator value="user.photos">
			<li>
			<a href="javascript:void(0);" onclick="showImg('/<s:property value="user.name"/>/<s:property value="fileName"/>','<s:property value="title"/>');">
	...
	<td width="660" align="center" valign="middle">
		<div style="font-family:黑体;font-size:20px;" id="imageTitle">title</div>
		<div style="width:640px;height:430px;overflow:auto">
			<img id="show" alt="当前相片" height="100%" onload="loaded();"></img>
